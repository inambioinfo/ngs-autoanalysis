...
def main():
    ...
    parser.add_argument("--lims", dest="lims", action="store", choices=list(auto_glslims.LIMS_SERVERS()), default=auto_glslims.LIMS_SERVERS['dev'], help="lims servers to choose from %s - default set to %s" % (list(auto_glslims.LIMS_SERVERS.viewkeys()), auto_glslims.LIMS_SERVERS['dev']))
