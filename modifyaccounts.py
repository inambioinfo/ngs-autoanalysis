        ...
        for account in all_accounts.lab:
            ...
            try:
                if lab.billing_address.institution == 'CRUK Cambridge Institute':
                    ...
                    if options.update:
                        field_new_value = 'John.Wells@cruk.cam.ac.uk, James.Hadfield@cruk.cam.ac.uk, Hannah.Haydon@cruk.cam.ac.uk, Fatimah.Bowater@cruk.cam.ac.uk, Paul.Coupland@cruk.cam.ac.uk'
