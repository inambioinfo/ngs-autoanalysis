...
Artifacts do not support HTTP POST requests.
    ...
    _ElementMap.update({
        ...
        __workflow_stages.name() : __workflow_stages,
        __file.name() : __file,
...
class workflow_stage (pyxb.binding.basis.complexTypeDefinition):
    """
...
def _BuildAutomaton_2 ():
    ...
    st_2._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
artifacts_._Automaton = _BuildAutomaton_2()
...
def _BuildAutomaton_3 ():
    ...
    st_0._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
details_._Automaton = _BuildAutomaton_3()
