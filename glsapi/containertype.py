...
# Generated 2015-01-06 15:57:40.184625 by PyXB version 1.2.3
...
cannot be used by containers of the container type to store artifacts or reagents.
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 177, 2)
    _Documentation = u'\n        Unavailable-well is a child element of container type and identifies a well location that\ncannot be used by containers of the container type to store artifacts or reagents.\n      '
...
type.
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 5, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element is-tube uses Python identifier is_tube
    __is_tube = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, u'is-tube'), 'is_tube', '__httpgenologics_comricontainertype_container_type__is_tube', False, pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 36, 6), )
    ...
    __unavailable_well = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, u'unavailable-well'), 'unavailable_well', '__httpgenologics_comricontainertype_container_type__unavailable_well', True, pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 57, 6), )
    ...
    __x_dimension = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, u'x-dimension'), 'x_dimension', '__httpgenologics_comricontainertype_container_type__x_dimension', False, pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 67, 6), )
    ...
    __y_dimension = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, u'y-dimension'), 'y_dimension', '__httpgenologics_comricontainertype_container_type__y_dimension', False, pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 77, 6), )
    ...
    __name._DeclarationLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 88, 4)
    __name._UseLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 88, 4)
    ...
    __uri._DeclarationLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 98, 4)
    __uri._UseLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 98, 4)
...
reserved for calibrants in containers of the container type.
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 109, 2)
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __name._DeclarationLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 119, 8)
    __name._UseLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 119, 8)
...
of the horizontal and vertical dimensions of the coordinate system of the container type.
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 132, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element is-alpha uses Python identifier is_alpha
    __is_alpha = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, u'is-alpha'), 'is_alpha', '__httpgenologics_comricontainertype_dimension_is_alpha', False, pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 140, 6), )
    ...
    __offset = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, u'offset'), 'offset', '__httpgenologics_comricontainertype_dimension_offset', False, pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 153, 6), )
    ...
    __size = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, u'size'), 'size', '__httpgenologics_comricontainertype_dimension_size', False, pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 165, 6), )
...
of links in the overall results.
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 186, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __next_page = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, u'next-page'), 'next_page', '__httpgenologics_comricontainertype_container_types__next_page', False, pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 212, 6), )
...
class container_type_link (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 222, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __name._DeclarationLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 228, 4)
    __name._UseLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 228, 4)
    ...
    __uri._DeclarationLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 235, 4)
    __uri._UseLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 235, 4)
...
container_type = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'container-type'), container_type_, location=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 3, 2))
Namespace.addCategoryObject('elementBinding', container_type.name().localName(), container_type)

container_types = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'container-types'), container_types_, location=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 4, 2))
Namespace.addCategoryObject('elementBinding', container_types.name().localName(), container_types)



container_type_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'is-tube'), pyxb.binding.datatypes.boolean, scope=container_type_, documentation=u'\n            is-tube describes if this container-type should be treated as a tube in the client interface.\n<br/>Always returns with GET: Yes\n<br/>Creatable with POST: Yes\n<br/>Required for POST: No\n          ', location=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 36, 6)))

container_type_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'calibrant-well'), calibrant_well, scope=container_type_, documentation=u'\n            Deprecated, this property is no longer supported.\nEach calibrant well identifies a well location that is reserved for calibrants in containers of the container type.\n<br/>Always returns with GET: No\n<br/>Creatable with POST: No\n<br/>Required for POST: No\n          ', location=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 46, 6)))

container_type_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'unavailable-well'), unavailable_well, scope=container_type_, documentation=u'\n            Each unavailable well identifies a well location that cannot be used by containers of the container type to store artifacts or reagents.\n<br/>Always returns with GET: No\n<br/>Creatable with POST: Yes\n<br/>Required for POST: No\n          ', location=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 57, 6)))

container_type_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'x-dimension'), dimension, scope=container_type_, documentation=u'\n            X-dimension describes the size and identification method of the horizontal axis of the coordinate system for the container type.\n<br/>Always returns with GET: Yes\n<br/>Creatable with POST: Yes\n<br/>Required for POST: Yes\n          ', location=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 67, 6)))

container_type_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'y-dimension'), dimension, scope=container_type_, documentation=u'\n            Y-dimension describes the size and identification method of the vertical axis of the coordinate system for the container type.\n<br/>Always returns with GET: Yes\n<br/>Creatable with POST: Yes\n<br/>Required for POST: Yes\n          ', location=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 77, 6)))
...
def _BuildAutomaton ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1, metadata=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 36, 6))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 46, 6))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 57, 6))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0L, max=1, metadata=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 67, 6))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0L, max=1, metadata=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 77, 6))
    counters.add(cc_4)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(container_type_._UseForTag(pyxb.namespace.ExpandedName(None, u'is-tube')), pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 36, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(container_type_._UseForTag(pyxb.namespace.ExpandedName(None, u'calibrant-well')), pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 46, 6))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(container_type_._UseForTag(pyxb.namespace.ExpandedName(None, u'unavailable-well')), pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 57, 6))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(container_type_._UseForTag(pyxb.namespace.ExpandedName(None, u'x-dimension')), pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 67, 6))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(container_type_._UseForTag(pyxb.namespace.ExpandedName(None, u'y-dimension')), pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 77, 6))
...
def _BuildAutomaton_ ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1, metadata=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 140, 6))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1, metadata=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 153, 6))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=1, metadata=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 165, 6))
    counters.add(cc_2)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(dimension._UseForTag(pyxb.namespace.ExpandedName(None, u'is-alpha')), pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 140, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(dimension._UseForTag(pyxb.namespace.ExpandedName(None, u'offset')), pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 153, 6))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(dimension._UseForTag(pyxb.namespace.ExpandedName(None, u'size')), pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 165, 6))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_2 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 197, 6))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1, metadata=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 204, 6))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=1, metadata=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 212, 6))
    counters.add(cc_2)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(container_types_._UseForTag(pyxb.namespace.ExpandedName(None, u'container-type')), pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 197, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(container_types_._UseForTag(pyxb.namespace.ExpandedName(None, u'previous-page')), pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 204, 6))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(container_types_._UseForTag(pyxb.namespace.ExpandedName(None, u'next-page')), pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/containertype.xsd', 212, 6))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_0, [
