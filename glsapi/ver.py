...
# Generated 2015-01-06 15:57:40.182069 by PyXB version 1.2.3
...
class version_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/ver.xsd', 4, 2)
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __uri._DeclarationLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/ver.xsd', 5, 4)
    __uri._UseLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/ver.xsd', 5, 4)
    ...
    __major._DeclarationLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/ver.xsd', 12, 4)
    __major._UseLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/ver.xsd', 12, 4)
    ...
    __minor._DeclarationLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/ver.xsd', 21, 4)
    __minor._UseLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/ver.xsd', 21, 4)
...
class versions_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/ver.xsd', 30, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element version uses Python identifier version
    __version = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpgenologics_comriversion_versions__version', True, pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/ver.xsd', 37, 6), )
...
version = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'version'), version_, location=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/ver.xsd', 2, 2))
Namespace.addCategoryObject('elementBinding', version.name().localName(), version)

versions = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'versions'), versions_, location=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/ver.xsd', 3, 2))
Namespace.addCategoryObject('elementBinding', versions.name().localName(), versions)



versions_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'version'), version_, scope=versions_, documentation=u'\n            Each version provides a URI to a supported version in the system.\n          ', location=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/ver.xsd', 37, 6)))
...
def _BuildAutomaton ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/ver.xsd', 37, 6))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(versions_._UseForTag(pyxb.namespace.ExpandedName(None, u'version')), pyxb.utils.utility.Location('http://genomicsequencing.cruk.cam.ac.uk:8080/glsstatic/lablink/downloads/xsd/ver.xsd', 37, 6))
